...
<!-- Js Check No Send -->
<script src="<?php echo base_url().'assets/js_ajax/ajax_no_data2.js'; ?>"></script>
<!-- Js Check Yes Send -->
<script src="<?php echo base_url().'assets/js_ajax/ajax_yes_data2.js'; ?>"></script>
<!-- JS Click_ Yes -->
<script src="<?php echo base_url().'assets/js_ajax/Click_yes2.js'; ?>"></script>
<!-- JS Lang -->
